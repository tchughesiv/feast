...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FeastJob) DeepCopyInto(out *FeastJob) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FeastJob.
func (in *FeastJob) DeepCopy() *FeastJob {
	if in == nil {
		return nil
	}
	out := new(FeastJob)
...
func (in *FeatureStoreSpec) DeepCopyInto(out *FeatureStoreSpec) {
	*out = *in
	...
	if in.FeastJob != nil {
		in, out := &in.FeastJob, &out.FeastJob
		*out = new(FeastJob)
		(*in).DeepCopyInto(*out)
	}
	if in.Services != nil {
