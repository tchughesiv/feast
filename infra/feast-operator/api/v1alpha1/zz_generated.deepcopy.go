...
func (in *FeatureStoreServices) DeepCopyInto(out *FeatureStoreServices) {
	*out = *in
	if in.Offline != nil {
		...
		*out = new(OfflineService)
		(*in).DeepCopyInto(*out)
	}
	if in.Online != nil {
		in, out := &in.Online, &out.Online
		*out = new(OnlineService)
		(*in).DeepCopyInto(*out)
	}
	if in.Registry != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OfflineService) DeepCopyInto(out *OfflineService) {
	*out = *in
	in.ServiceConfig.DeepCopyInto(&out.ServiceConfig)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OfflineService.
func (in *OfflineService) DeepCopy() *OfflineService {
	if in == nil {
		return nil
	}
	out := new(OfflineService)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OnlineService) DeepCopyInto(out *OnlineService) {
	*out = *in
	in.ServiceConfig.DeepCopyInto(&out.ServiceConfig)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OnlineService.
func (in *OnlineService) DeepCopy() *OnlineService {
	if in == nil {
		return nil
	}
	out := new(OnlineService)
